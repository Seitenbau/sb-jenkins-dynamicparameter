...
public class ScriptlerBooleanParameterDefinition extends ScriptlerParameterDefinition
{
  /** Serial version UID. */
  ...
  public ScriptlerBooleanParameterDefinition(String name, String description, String uuid,
  ...
  public final boolean getDefaultValue()
  {
    ...
    return Boolean.parseBoolean(getScriptResultAsString(parameters));
  }
  ...
  public static final class DescriptorImpl extends ParameterDescriptor
  {
    ...
    {
      return ResourceBundleHolder.get(ScriptlerBooleanParameterDefinition.class)
          .format(DISPLAY_NAME);
    }
